                          ...
                          children: [
                            ...
                            if (_errorMessage != null) ...[
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: AppColors.crimsonLockout.withValues(alpha: 0.06),
                                  borderRadius: BorderRadius.circular(8),
                                  border: Border.all(color: AppColors.crimsonLockout.withValues(alpha: 0.2)),
                                ),
                                child: Row(
                                  children: [
                                    const Icon(Icons.error_outline, color: AppColors.crimsonLockout, size: 16),
                                    const SizedBox(width: 8),
                                    Expanded(
                                      child: Text(
                                        _errorMessage!,
                                        style: const TextStyle(fontSize: 11, color: AppColors.crimsonLockout),
                                      ),
                                    ),
                                  ],
                                ),
                            ...
                            const Text('Password', style: TextStyle(fontSize: 11, color: AppColors.mutedText, fontWeight: FontWeight.w600)),
                            const SizedBox(height: 6),
                            Container(
                              decoration: BoxDecoration(
                                color: AppColors.darkRimGray,
                            ...
                            _isLoading
                                ? const Center(
                                    child: SizedBox(
                                      width: 24,
                                      height: 24,
                                      child: CircularProgressIndicator(strokeWidth: 2, valueColor: AlwaysStoppedAnimation<Color>(AppColors.clinicalBlue)),
                                    ),
                                  )
                                : Column(
                                    children: [
                            ...
                            Center(
                              child: InkWell(
                                ...
                                child: Text(
                                  ...
                                  style: const TextStyle(fontSize: 12, color: AppColors.clinicalBlue, fontWeight: FontWeight.w500),
                                ),
                              ),
                            ),
                          ],
